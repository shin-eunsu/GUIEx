...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        mainLayout.addWidget(self.clearButton, 1, 0, 1, 2)
        mainLayout.addWidget(self.backspaceButton, 1, 2, 1, 2)
        mainLayout.addWidget(self.equalButton, 1, 4, 1, 2)
        ...
        for i in range(1, Calculator.NumDigitButtons):
            row = ((9 - i) / 3) + 2
            column = ((i - 1) % 3) + 1
            mainLayout.addWidget(self.digitButtons[i], row, columnimport math
...
class Calculator(QWidget):
    ...
    def calculate(self, rightOperand, pendingOperator):
        if pendingOperator == "+":
            self.sumSoFar += rightOperanimport math
